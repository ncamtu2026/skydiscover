#!/usr/bin/env bash
# Visualize GraphEvolve runs. The timeline is coloured by per-iteration policy mode
# (exploit / crossover / explore·new-formulation / explore·new-direction); the right
# panel shows the ExperienceGraph tree.
#
# Env vars:
