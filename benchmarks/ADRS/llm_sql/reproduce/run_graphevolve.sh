#!/usr/bin/env bash
# LLM SQL — GraphEvolve: policy-driven search over the ExperienceGraph (no islands).
...
wait
echo "llm_sql graphevolve: finished."
