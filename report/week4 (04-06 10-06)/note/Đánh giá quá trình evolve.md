...
### Trực quan hoá
Từ quan điểm trên kết hợp với phân tích về cách hoạt động của [[Code/skydiscover/report/week4 (04-06 10-06)/note/Ada evolve]], cần cải tiến website trực quan hoá dữ liệu tại /analysis từ các nguồn dữ liệu sau:
